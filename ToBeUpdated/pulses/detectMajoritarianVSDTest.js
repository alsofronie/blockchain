...
var pdsInM = require("../../../pskdb/lib/InMemoryPDS");
...
assert.equal(majoritarian, 'none',"Majoritatian should be none");
...
var expected = 100101010;
var majoritarian = cutil.detectMajoritarianVSD(currentPulse, pulsesHistory, votingBox);

assert.equal(majoritarian, expected, "Wrong majoritarian");